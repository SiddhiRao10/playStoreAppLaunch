...
## Requirements
- usual environment variables (BROWSERSTACK_USERNAME,BROWSERSTACK_ACCESS_KEY,BROWSERSTACK_BUILD_NAME,BROWSERSTACK_APP_ID - this is needed even though technically the app is not being tested here)
